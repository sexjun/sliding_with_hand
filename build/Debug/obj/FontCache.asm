; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29913.0 
	...
	TITLE	C:\TouchGFXProjects\MyApplication_4\build\Debug\obj\FontCache.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__F20878B9_FontCache@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	??_C@_1KM@OEGHOFGO@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ ; `string'
...
??_C@_1IE@NPIIMJBA@?$AAt?$AAy?$AAp?$AAe?$AAd?$AAT?$AAe?$AAx?$AAt?$AAs?$AA?5?$AA?$CB?$AA?$DN?$AA?5?$AA0@ DB 't'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1KM@OEGHOFGO@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
CONST	SEGMENT
??_C@_1KM@OEGHOFGO@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ DB 'C'
	...
	DB	'T', 00H, 'y', 00H, 'p', 00H, 'e', 00H, 'd', 00H, 'T', 00H, 'e'
	DB	00H, 'x', 00H, 't', 00H, '.', 00H, 'h', 00H, 'p', 00H, 'p', 00H
	DB	00H, 00H					; `string'
CONST	ENDS
...
; _this$ = ecx
; File C:\TouchGFXProjects\MyApplication_4\generated\fonts\include\fonts\CachedFont.hpp
; Line 60
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __43362C81_CachedFont@hpp
...
; _this$ = ecx
; File C:\TouchGFXProjects\MyApplication_4\generated\fonts\src\FontCache.cpp
; Line 372
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __F20878B9_FontCache@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 373
	mov	eax, DWORD PTR _this$[ebp]
...
$LN3@assertVali:
	mov	esi, esp
	push	177					; 000000b1H
	push	OFFSET ??_C@_1KM@OEGHOFGO@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
